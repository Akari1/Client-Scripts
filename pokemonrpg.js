...
events = ({
    beforeSendMessage: function (message, channel) {
        ...
        if (message.charAt(0) === "~") {
            ...
            if (command === "help") {
                sys.stopevent();
                client.printLine("*** Pokemon RPG Commands ***");
                client.printLine("~end: To see credits.");
                client.printLine("That's all for now!");
            }
            if (command === "attackcaterpie") {
                ...
                client.printLine("Aria: What will you do? ~attackcaterpie2,~run or ~bag");
                return;
            }
            if (command === "attackcaterpie2") {
                sys.stopEvent();
            ...
            if (command === "nothing") {
                sys.stopEvent("This does nothing.");
                return;
            }
        }
    }
